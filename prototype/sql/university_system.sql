...
ALTER TABLE `submissions`
  ...
  ADD KEY `fk_submissions_enrollment` (`enrollment_id`);
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `fk_courses_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `submissions`
  ...
  ADD CONSTRAINT `fk_submissions_enrollment` FOREIGN KEY (`enrollment_id`) REFERENCES `enrollments` (`enrollment_id`) ON DELETE CASCADE;
